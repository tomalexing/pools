...
class Privacy extends React.Component{
    ...
    render(){
        ...
        <Typography className={classes.white} gutterBottom style={{textAlign: 'center'}} variant='h2'> PRIVACY POLICY </Typography>
        <Typography className={classes.white} gutterBottom style={{marginTop: '-10px',textAlign: 'center'}} variant='h1'> Quizi </Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'> Last update: 7/6/18 </Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'> A word from Quizi </Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>Thank you for visiting Quizi.com!
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>1. Introduction </Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'> This Privacy Policy together with the <a href="https://www.quizi.io/term-of-use" className={classes.link}>Terms of Use</a> form the entire legal Agreement (“Agreement”) between ION digital (“Quizi”, “Company”, “we”, “us” or “our”) and you as a user (“you”, “user”). The Agreement Applies to our Internet web site located at the URL’s <a href="/" className={classes.link}> quizi.io</a> (“Site”).
        </Typography>

        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>2. What types of information we collect? </Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>There are three general categories of information we collect:
        </Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>
            <ul>
        ...
        <Typography className={classes.white} gutterBottom  variant='body2'>(For your convenience we provide you with bullet-points, however we also provide a full reasoning for each article. So let’s take a closer at everything.)
        </Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'> 2.1. Information we collect automatically </Typography>

        <Typography className={classes.white} gutterBottom  variant='body2'> You can generally visit our Site without submitting any personally identifiable information about yourself. However, keep in mind that our Site collects certain information automatically. This information is necessary for the proper communication between you and us and to provide our services and improve its functionalities. We use automatically collected information to personalise your experience and improve our services. Such information includes: 
        </Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>
            <ul>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>2.2. Information you give us
        </Typography>
        
        <Typography className={classes.white} gutterBottom  variant='body2'>To use full range of services and functionality of the Site, you will be required to register  an account. The registration of an account has a voluntary nature. You may register an account by signing up via <a className={classes.link} href="httpss://www.facebook.com/privacy/explanation">Facebook</a> or <a className={classes.link} href="httpss://policies.google.com/privacy">Google</a>. </Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>You may also choose to give us certain information:
            <ul>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>3.1. Provision, improvement and development of our Site.  </Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>We use your information to:
            <ul>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>3.2. Prevention of fraudulent actions and creation of trusted environment.</Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>We use your information to:
            <ul>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>3.3. Making your experience more personalized</Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>We use your information to:
            <ul>
        ...
        <Typography className={classes.white} gutterBottom  variant='body2'>Please also note that if you choose not to receive marketing-related emails from us, we may still send you non-marketing important administrative messages or notifications.</Typography>

        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>4. HOW WE SHARE AND DISCLOSE INFORMATION?</Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>We may share and disclose information that we collect for following reasons:
            <ul>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>4.1. With your consent</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>In cases where you have provided your explicit consent, we may share your personal information, as described at the time of consent. Example of such usage may be when you authorize a third party website to access your Quizi account.</Typography>
        
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>4.2. Safety, Legal purposes, and Law enforcement.</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>We will disclose your personally identifiable information (a) if we are required to do so by law, regulation or other government authority or otherwise in cooperation with an ongoing investigation of a governmental authority, (b) to enforce the Quizi Terms of Use or user agreements or to protect our rights or (c) to protect the safety of users of our Site and our services.
        </Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>4.3. Service providers</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>We may provide your personally identifiable information and the data generated by cookies and the aggregate information to the vendors and service agencies that we may engage to assist us in providing our services to you for their use solely to provide us with such assistance. Such third parties’ use of your personally identifiable information is subject to the third party’s Applicable privacy policy terms and we may also enter into Model Contracts for the transfer of personal data to third countries with such third party vendors and service agencies.</Typography>

        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>4.4. Business transfers </Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>We will not sell your personally identifiable information to any company or organization, but we may transfer your personally identifiable information to a successor entity upon a merger, consolidation or other corporate reorganization in which Quizi participates or to a purchaser or acquirer of all or substantially all of Quizi's assets to which this Site relates. In such event we will notify you before your personal information is transferred and becomes subject to a different privacy policy.</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>4.5. Aggregated data.</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>Through the third party analytic providers and directly through our Site, we may track information that will be maintained, used and disclosed in aggregate form only and which will not contain your personally identifiable information. For example, without limitation, the total number of visitors to our Site, the number of visitors to each page of our Site, browser type, External Web Sites (defined below) linked to and IP addresses. We may analyze this data for trends and statistics in the aggregate, and we may use such aggregate information to administer the Site, and gather broad demographic information for aggregate use.</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>5. OTHER IMPORTANT INFORMATION</Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>In this section we will describe other important information that our users need to know. Such information includes:
            <ul>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.1 Manage and control your Information </Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>You may access and update some of your information through your Account settings. You are responsible for keeping your personal information up-to-date. 
        </Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.2 Rectification of Inaccurate or Incomplete Information</Typography>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.3 Data Access and Portability</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>In some jurisdictions, Applicable law may entitle you to request copies of your personal information held by us. You may also be entitled to request copies of personal information that you have provided to us in a structured, commonly used, and machine-readable format and/or request us to transmit this information to another service provider (where technically feasible).</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.4 Data Retention and right to be forgotten</Typography>
        <Typography className={classes.white} gutterBottom variant='body2'>We generally retain your personal information for as long as is necessary for the provision of  our service to you and to comply with our legal obligations. If you no longer want us to use your information to provide the services to you, you can execute your right to be forgotten.  Please note that if you request the erasure of your personal information:</Typography>
        <Typography className={classes.white} gutterBottom variant='body2'>We may retain some of your personal information as necessary for our legitimate business interests, such as fraud detection and prevention and enhancing safety. For example, if we suspend an account for fraud or safety reasons, we may retain certain information from that account to prevent that user from opening a new account in the future.</Typography>
        <Typography className={classes.white} gutterBottom variant='body2'>Additionally, some copies of your information (e.g., log records) may remain in our database, but are disassociated from personal identifiers.
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.5 Withdrawing Consent and Restriction of Processing</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>Where you have provided your consent to the processing of your personal information by Quizi you may withdraw your consent at any time by sending a communication to us specifying which consent you are withdrawing. Please note that the withdrawal of your consent does not affect the lawfulness of any processing activities based on such consent before its withdrawal. Additionally, in some jurisdictions, Applicable law may give you the right to limit the ways in which we use your personal information, in particular where (i) you contest the accuracy of your personal information; (ii) the processing is unlawful and you oppose the erasure of your personal information; (iii) we no longer need your personal information for the purposes of the processing, but you require the information for the establishment, exercise or defence of legal claims; or (iv) you have objected to the processing pursuant to Section 6.6 and pending the verification whether the legitimate grounds of Quizi override your own.</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.6 Objection to Processing</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>In some jurisdictions, Applicable law may entitle you to require Quizi not to process your personal information for certain specific purposes (including profiling) where such processing is based on legitimate interest. If you object to such processing we will no longer process your personal information for these purposes unless we can demonstrate compelling legitimate grounds for such processing or such processing is required for the establishment, exercise or defence of legal claims.</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>Where your personal information is processed for direct marketing purposes, you may, at any time ask us to cease processing your data for these direct marketing purposes by sending an email to <a className={classes.link}href="mailto:support@quizi.io">support@quizi.io</a>.</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.7 Lodging Complaints</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>You have the right to lodge complaints about the data processing activities carried out by us before the competent data protection authorities.</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>6.8. Automated individual decision-making</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>While using our Site you will always have an option to opt-in or to opt-out. Our Site doesn’t automatically make decisions for you.</Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='h6'>7. HOW DO WE SECURE INFORMATION?</Typography>
        <Typography className={classes.white} gutterBottom  variant='body2'>We may employ procedural and technological measures that are generally consistent with industry practice. Such measures are reasonably designed to help protect your personally identifiable information from loss, unauthorized access, disclosure, alteration or destruction. Quizi may use encryption, secure socket layer and password protection to help prevent unauthorized access to your personally identifiable information.</Typography>
        <Typography component="div" className={classes.white} gutterBottom  variant='body2'>Moreover, we are actively monitoring and enforcing the information protection standards during all of our activities, namely:
            <ul>
