...
class Term extends React.Component{
    ...
    render(){
        ...
        <Typography className={classes.white} gutterBottom  variant='body1'>To use full functionality of our Service (such as redeeming your reward for completing a poll or a quiz) you will have to register a Quizi Account (“Account”). You may get access to Account by logging in through Facebook or Google plus. When you provide us with any type of your personal information such provision will covered by our <a className={classes.link} href="http://www.quizi.io/privacy-policy">Privacy Policy</a>. When you log into your Account through <a className={classes.link} href="https://policies.google.com/privacy">Google</a> or <a className={classes.link} href="https://www.facebook.com/privacy/explanation">Facebook</a> the processing of your personal information will be subjected to their Privacy Policies, so we highly recommend you to read them first prior to providing us with any information.
        </Typography>
        ...
        <Typography className={classes.white} gutterBottom  variant='body1'>
        For more information about the procedure of information collection, processing, disclosure etc., please familiarize yourself with our Privacy Policy. We strongly encourage you to read our <a href="http://www.quizi.io/privacy-policy" className={classes.link}> Privacy Policy</a> .</Typography>
