...
class Term extends React.Component{
    ...
    render(){
        ...
        <Typography className={classes.white} gutterBottom variant='display3'> Quizion Terms of Use </Typography>
        <Typography className={classes.white} gutterBottom  variant='body1'> This is a contract between you and the folks at ION digital (who created <a href="/" className={classes.link}> www.quizi.io </a> - “Quizion”) when you use the <a href="/" className={classes.link}>www.quizi.io</a> (“Site”) and the services and products found there (“Services”). We’re excited that you’re using Quizion and would love your feedback. We created Quizion to allow anyone to create a Poll and share it with the world. We think everyone should read this before accessing our site. </Typography>

        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='title'>This is a binding agreement </Typography>
        <Typography className={classes.white} gutterBottom  variant='body1'>By accessing or using any part of the web site, you agree to become bound by the terms and conditions of this agreement. If you do not agree to all the terms and conditions of this agreement, then you may not access the Site or use any services. If these terms and conditions are considered an offer by Quizion, acceptance is expressly limited to these terms. </Typography>

        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='title'> Who can use our Services </Typography>
        <Typography className={classes.white} gutterBottom  variant='body1'> Quizion is only for human adults and teenagers above the age of 18 years old.
        </Typography>
        ...
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='title'>Your Quizion Account </Typography>
        ...
        <Typography className={classes.white} gutterBottom  variant='body1'>As Quizion asks others to respect its intellectual property rights, it respects the intellectual property rights of others. Quizion deals with copyright infringement in accordance to the Digital Millennium Copyright Act. If you believe that material located on or linked to by <a className={classes.link} href="quizi.io">www.quizi.io</a> violates your copyright, you are encouraged to notify Quizion. Quizion will respond to all such notices, including as required or appropriate by removing the infringing material or disabling all links to the infringing material. Quizion will terminate a visitor’s access to and use of the Site if, under appropriate circumstances, the visitor is determined to be a repeat infringer of the copyrights or other intellectual property rights of Quizion or others. In the case of such termination, Quizion will have no obligation to provide a refund of any amounts previously paid to Quizion. The contact information for Quizion’s designated agent for receipt of notices of claimed infringement is here: ION digital Email: <a className={classes.link} href="mailto:support@quizi.io">support@quizi.io</a> </Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='title'>Disclaimer of Warranties </Typography>
        <Typography className={classes.white} gutterBottom  variant='body1'>The Site is provided “as is”. Quizion and its suppliers and licensors hereby disclaim all warranties of any kind, express or implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose and non-infringement. Neither Quizion nor its suppliers and licensors, makes any warranty that the Site will be error free or that access thereto will be continuous or uninterrupted. If you’re actually reading this, here’s a treat. You understand that you download from, or otherwise obtain content or services through, the Site at your own discretion and risk. </Typography>
        <Typography className={classes.white + ' ' + classes.enlarge} gutterBottom  variant='title'>Limitation of Liability </Typography>
        <Typography className={classes.white} gutterBottom  variant='body1'>In no event will Quizion, or its suppliers or licensors, be liable with respect to any subject matter of this agreement under any contract, negligence, strict liability or other legal or equitable theory for: (i) any special, incidental or consequential damages; (ii) the cost of procurement for substitute products or services; (iii) interruption of use or loss or corruption of data; or (iv) any amounts that exceed the fees paid by you to Quizion under this agreement during the twelve (12) month period prior to the cause of action. Quizion shall have no liability for any failure or delay due to matters beyond their reasonable control. The foregoing shall not apply to the extent prohibited by applicable law. </Typography>
