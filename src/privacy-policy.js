...
class Privacy extends React.Component{
    ...
    render(){
        ...
        <Typography className={classes.white} gutterBottom  variant='body1'> This Privacy Policy together with the <a href="http://www.quizi.io/term-of-use" className={classes.link}>Terms of Use</a> form the entire legal Agreement (“Agreement”) between ION digital (“Quizi”, “Company”, “we”, “us” or “our”) and you as a user (“you”, “user”). The Agreement Applies to our Internet web site located at the URL’s <a href="/" className={classes.link}> quizi.io</a> (“Site”).
        </Typography>
        ...
        <Typography className={classes.white} gutterBottom  variant='body1'>To use full range of services and functionality of the Site, you will be required to register  an account. The registration of an account has a voluntary nature. You may register an account by signing up via <a className={classes.link} href="https://www.facebook.com/privacy/explanation">Facebook</a> or <a className={classes.link} href="https://policies.google.com/privacy">Google</a>. </Typography>
